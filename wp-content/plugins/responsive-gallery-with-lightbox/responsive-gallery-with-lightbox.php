<?php
/**
 * Plugin Name: Responsive Gallery With Light-box - Images Gallery for WordPress
 * Version: 1.8.1
...
function wrgf_SettingsPage() {
	add_submenu_page( 'edit.php?post_type=wrgf_gallery', esc_html__( 'Help and Support', WRGF_TEXT_DOMAIN ), esc_html__( 'Help and Support', WRGF_TEXT_DOMAIN ), 'administrator', 'WRGF-help-page', 'WRGF_Help_and_Support_page' );
	add_submenu_page( 'edit.php?post_type=wrgf_gallery', esc_html__( 'Pro Screenshots', WRGF_TEXT_DOMAIN ), esc_html__( 'Pro Screenshots', WRGF_TEXT_DOMAIN ), 'administrator', 'WRGF-Pro-Plugin', 'WRGF_Pro_page_Function' );
	add_submenu_page( 'edit.php?post_type=wrgf_gallery', esc_html__( 'Recommendation', WRGF_TEXT_DOMAIN ), esc_html__( 'Recommendation', WRGF_TEXT_DOMAIN ), 'administrator', 'WRGF-Recommendation-page', 'WRGF_Recommendation_page' );
}
...
function WRGF_Pro_page_Function() {
	//css
    wp_enqueue_style( 'bootstrap', WRGF_PLUGIN_URL . 'css/bootstrap.min.css' );
	wp_enqueue_style( 'fontawesome-5', WRGF_PLUGIN_URL . 'css/all.min.css' );
...
class WRGF {
	...
	public function wrgf_register_cpt_function() {
		$labels = array(
			'name'               => esc_html__( 'Responsive Gallery', WRGF_TEXT_DOMAIN ),
			'singular_name'      => esc_html__( 'Responsive Gallery', WRGF_TEXT_DOMAIN ),
			'add_new'            => esc_html__( 'Add New Gallery', WRGF_TEXT_DOMAIN ),
			'add_new_item'       => esc_html__( 'Add New Gallery', WRGF_TEXT_DOMAIN ),
			'edit_item'          => esc_html__( 'Edit Photo Gallery', WRGF_TEXT_DOMAIN ),
			'new_item'           => esc_html__( 'New Gallery', WRGF_TEXT_DOMAIN ),
			'view_item'          => esc_html__( 'View Gallery', WRGF_TEXT_DOMAIN ),
			'search_items'       => esc_html__( 'Search Galleries', WRGF_TEXT_DOMAIN ),
			'not_found'          => esc_html__( 'No galleries found', WRGF_TEXT_DOMAIN ),
			'not_found_in_trash' => esc_html__( 'No galleries found in Trash', WRGF_TEXT_DOMAIN ),
			'parent_item_colon'  => esc_html__( 'Parent Gallery:', WRGF_TEXT_DOMAIN ),
			'all_items'          => esc_html__( 'All Galleries', WRGF_TEXT_DOMAIN ),
			'menu_name'          => esc_html__( 'Responsive Gallery', WRGF_TEXT_DOMAIN ),
		);
	...
	function wrgf_gallery_columns( $columns ) {
		$columns = array(
			...
			'title'     => esc_html__( 'Gallery', WRGF_TEXT_DOMAIN ),
			'shortcode' => esc_html__( 'Gallery Shortcode', WRGF_TEXT_DOMAIN ),
			'author'    => esc_html__( 'Author', WRGF_TEXT_DOMAIN ),
			'date'      => esc_html__( 'Date', WRGF_TEXT_DOMAIN )
		);
		return $columns;
	}
	...
	public function add_all_wrgf_meta_boxes() {
		add_meta_box( esc_html__( 'Add Images', WRGF_TEXT_DOMAIN ), esc_html__( 'Add Images', WRGF_TEXT_DOMAIN ), array(
			&$this,
			'wrgf_generate_add_image_meta_box_function'
		), 'wrgf_gallery', 'normal', 'low' );
		add_meta_box( esc_html__( 'Apply Setting On Photo Gallery', WRGF_TEXT_DOMAIN ), esc_html__( 'Apply Setting On Photo Gallery', WRGF_TEXT_DOMAIN ), array(
			&$this,
			'wrgf_settings_meta_box_function'
		), 'wrgf_gallery', 'normal', 'low' );
		add_meta_box( esc_html__( 'Responsive Gallery Shortcode', WRGF_TEXT_DOMAIN ), esc_html__( 'Responsive Gallery Shortcode', WRGF_TEXT_DOMAIN ), array(
			&$this,
			'wrgf_shotcode_meta_box_function'
		), 'wrgf_gallery', 'side', 'low' );
		add_meta_box( esc_html__( 'Responsive Photo Gallery Pro', WRGF_TEXT_DOMAIN ), esc_html__( 'Responsive Photo Gallery Pro', WRGF_TEXT_DOMAIN ), array(
			&$this,
			'wrgf_pro_features'
		), 'wrgf_gallery', 'side', 'low' );
		add_meta_box( esc_html__( 'Rate us on WordPress', WRGF_TEXT_DOMAIN ), esc_html__( 'Rate us on WordPress', WRGF_TEXT_DOMAIN ), array(
			&$this,
			'wrgf_rate_us_function'
		), 'wrgf_gallery', 'side', 'low' );
		add_meta_box( esc_html__( 'Upgrade To Pro Version', WRGF_TEXT_DOMAIN ), esc_html__( 'Upgrade To Pro Version', WRGF_TEXT_DOMAIN ), array(
			&$this,
	...
	function wrgf_rate_us_function() { ?>
        <div style="text-align:center">
            <h3><?php esc_html_e( 'If you like our plugin then please show us some love', WRGF_TEXT_DOMAIN ); ?> </h3>
            <style>
            ...
            <div class="upgrade-to-pro-demo" style="text-align:center;margin-bottom:10px;margin-top:10px;">
				...
				<?php esc_html_e( 'Click Here', WRGF_TEXT_DOMAIN ); ?></a>
            </div>
        </div>
		<?php
	}
	...
	function wrgf_upgrade_to_pro_function() { ?>
        <div class="upgrade-to-pro-demo" style="text-align:center;margin-bottom:10px;margin-top:10px;">
            <a href="http://demo.weblizar.com/responsive-photo-gallery-pro/" target="_new"
               class="button button-primary button-hero"><?php esc_html_e( 'View Live Demo', WRGF_TEXT_DOMAIN ); ?></a>
        </div>
        <div class="upgrade-to-pro-admin-demo" style="text-align:center;margin-bottom:10px;">
            <a href="http://demo.weblizar.com/responsive-photo-gallery-admin-demo/" target="_new"
               class="button button-primary button-hero"><?php esc_html_e( 'View Admin Demo', WRGF_TEXT_DOMAIN ); ?></a>
        </div>
        <div class="upgrade-to-pro" style="text-align:center;margin-bottom:10px;">
            <a href="http://weblizar.com/plugins/responsive-photo-gallery-pro/" target="_new"
               class="button button-primary button-hero"><?php esc_html_e( 'Upgarde To Pro', WRGF_TEXT_DOMAIN ); ?></a>
        </div>
		<?php
	}
	...
	function wrgf_pro_features() { 
        ...
        <div class="">
			...
			<a target="_blank" href="https://weblizar.com/plugins/responsive-photo-gallery-pro/">
				<?php esc_html_e( 'Buy Now $10', WRGF_TEXT_DOMAIN ); ?></a>
            </div>
            ...
            <div class="update_pro_button">
                <a class="upg_anch" target="_blank" href="https://weblizar.com/plugins/responsive-photo-gallery-pro/">
					<?php esc_html_e( 'Buy Now $10', WRGF_TEXT_DOMAIN ); ?>
				</a>
            </div>
        </div>
		<?php
	...
	public function wrgf_generate_add_image_meta_box_function( $post ) { ?>
				...
				if ( $TotalImages ) {
					foreach ( $WRGF_AllPhotosDetails as $WRGF_SinglePhotoDetails ) {
                        ...
                        <li class="rpg-image-entry" id="rpg_img">
                            <a class="gallery_remove wrgfgallery_remove" href="#wrgf_gallery_remove" id="wrgf_remove_bt">
								<img src="<?php echo WRGF_PLUGIN_URL . 'images/Close-icon-new.png'; ?>"/></a>
        ...
        <div class="rpg-image-entry add_rpg_new_image" id="wrgf_gallery_upload_button" data-uploader_title="Upload Image" data-uploader_button_text="Select">
            ...
            <p>
				<?php esc_html_e( 'Add New Image', WRGF_TEXT_DOMAIN ); ?>
            </p>
        </div>
        <!--Delete Image Button-->
        <div class="rpg-image-entry del_rpg_image" id="wrgf_delete_all_button">
            <div class="dashicons dashicons-trash"></div>
            <p><?php esc_html_e( 'Delete All Images', WRGF_TEXT_DOMAIN ); ?></p>
        </div>
        <div style="clear:left;"></div>
        <p><strong><?php esc_html_e( 'Tips', WRGF_TEXT_DOMAIN ); ?>
                :</strong> <?php esc_html_e( 'Plugin crop images with same size thumbnails', WRGF_TEXT_DOMAIN ); ?>
            . <?php esc_html_e( 'So', WRGF_TEXT_DOMAIN ); ?>
            , <?php esc_html_e( 'please upload all gallery images using Add New Image button', WRGF_TEXT_DOMAIN ); ?>
            . <?php esc_html_e( 'Don', WRGF_TEXT_DOMAIN ); ?>'<?php esc_html_e( 't use', WRGF_TEXT_DOMAIN ); ?>
            /<?php esc_html_e( 'add pre', WRGF_TEXT_DOMAIN ); ?>
            -<?php esc_html_e( 'uploaded images which are uploaded previously using Media', WRGF_TEXT_DOMAIN ); ?>
            /<?php esc_html_e( 'Post', WRGF_TEXT_DOMAIN ); ?>/<?php esc_html_e( 'Page', WRGF_TEXT_DOMAIN ); ?>.</p>
		<?php
	}
	...
	public function wrgf_shotcode_meta_box_function() { ?>
        <p><?php esc_html_e( "Use below shortcode in any Page/Post to publish your gallery", WRGF_TEXT_DOMAIN ); ?></p>
	...
	public function admin_thumb( $id ) {
        ...
        <li class="rpg-image-entry" id="rpg_img">
            <a class="gallery_remove wrgfgallery_remove" href="#wrgf_gallery_remove" id="wrgf_remove_bt">
				<img src="<?php echo WRGF_PLUGIN_URL . 'images/Close-icon-new.png'; ?>"/>
			</a>
            <img src="<?php echo esc_url($image[0]); ?>" class="rpg-meta-image" alt="" style="">
            <input type="button" id="upload-background-<?php echo esc_attr($UniqueString); ?>"
	...
	public function wrgf_add_image_meta_box_save( $PostID ) {
		if ( isset( $PostID ) && isset( $_POST['rpg_wl_action'] ) ) {
			$TotalImages = count( isset( $_POST['wrgf_image_url'] ) ? $_POST['wrgf_image_url'] : '' );
			$ImagesArray = array();
			if ( $TotalImages ) {
				for ( $i = 0; $i < $TotalImages; $i ++ ) {
					$image_label   = stripslashes( $_POST['wrgf_image_label'][ $i ] );
					$url           = sanitize_text_field($_POST['wrgf_image_url'][ $i ]);
					$url1          = sanitize_text_field($_POST['wrgf_image_url1'][ $i ]);
					$url2          = sanitize_text_field($_POST['wrgf_image_url2'][ $i ]);
					$url3          = sanitize_text_field($_POST['wrgf_image_url3'][ $i ]);
					$url4          = sanitize_text_field($_POST['wrgf_image_url4'][ $i ]);
					$ImagesArray[] = array(
	...
	public function wrgf_settings_meta_save( $PostID ) {
		if ( isset( $PostID ) && isset( $_POST['wl_wrgf_action'] ) && isset( $_POST['security'] ) ) {
			if ( ! wp_verify_nonce( $_POST['security'], 'nonce_wrgf_save_settings_option' ) ) {
		die();}
			$WL_Show_Gallery_Title   = sanitize_text_field($_POST['wl-show-gallery-title']);
			$WL_Show_Image_Label     = sanitize_text_field($_POST['wl-show-image-label']);
			$WL_Image_Label_Position = sanitize_text_field($_POST['wl-image-label-position']);
			...
			$WL_Thumbnail_Layout     = sanitize_text_field($_POST['wl-thumbnail-layout']);
			$WL_Hover_Color          = sanitize_text_field($_POST['wl-hover-color']);
			$WL_Hover_Text_Color     = sanitize_text_field($_POST['wl-hover-text-color']);
			$WL_Footer_Text_Color    = sanitize_text_field($_POST['wl-footer-text-color']);
			$WL_Hover_Color_Opacity  = sanitize_text_field($_POST['wl-hover-color-opacity']);
...
function rpgwl_settings_link_rpg($links) {
    $rpgwl_settings_link1 = '<a href="https://weblizar.com/plugins/responsive-photo-gallery-pro/" target="_blank" >'.esc_html__('Get Premium', WRGF_TEXT_DOMAIN).'</a>';
    $rpgwl_settings_link2 = '<a href="edit.php?post_type=wrgf_gallery">'.esc_html__('Settings', WRGF_TEXT_DOMAIN).'</a>';
...
function add_wrgf_inline_popup_content() {
    ...
    <div id="WRGF" style="display:none;">
        <h3><?php esc_html_e( 'Select Responsive Gallery to insert into post', WRGF_TEXT_DOMAIN ); ?></h3>
		<?php
		...
		if ( $wrgf_galleries->have_posts() ) { ?>
            ...
            <button class='button primary'
                    id='wrgfgalleryinsert'><?php esc_html_e( 'Insert Gallery Shortcode', WRGF_TEXT_DOMAIN ); ?></button>
			<?php
		} else {
			esc_html_e( "No Gallery Found", WRGF_TEXT_DOMAIN );
		} ?>
    </div>
	<?php
}
