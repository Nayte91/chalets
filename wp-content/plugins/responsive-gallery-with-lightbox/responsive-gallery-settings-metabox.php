    ...
    <tr>
        ...
        <td class="image_color">
            ...
            <input type="radio" name="wl-hover-color" id="wl-hover-color"
				...
				echo "checked";
			} ?>><label class="badge1" data-badge="<?php esc_attr_e( 'Color 1', WRGF_TEXT_DOMAIN ); ?>"></label>&nbsp;&nbsp;&nbsp;
            <input type="radio" name="wl-hover-color" id="wl-hover-color"
                   value="#000000" <?php if ( $WL_Hover_Color == '#000000' ) {
				echo "checked";
			} ?>><label class="badge4" data-badge="<?php esc_attr_e( 'Color 2', WRGF_TEXT_DOMAIN ); ?>"></label>&nbsp;&nbsp;&nbsp;
            <input type="radio" name="wl-hover-color" id="wl-hover-color"
                   value="#dd4242" <?php if ( $WL_Hover_Color == '#dd4242' ) {
				echo "checked";
			} ?>><label class="badge6" data-badge="<?php esc_attr_e( 'Color 2', WRGF_TEXT_DOMAIN ); ?>"></label>&nbsp;&nbsp;&nbsp;
    ...
    <tr>
        ...
        <td class="image_color">
            ...
            <input type="radio" name="wl-hover-text-color" id="wl-hover-text-color"
				...
				echo "checked";
			} ?>><label class="badge3" data-badge="<?php esc_attr_e( 'Color 1', WRGF_TEXT_DOMAIN ); ?>"></label>&nbsp;&nbsp;&nbsp;
            <input type="radio" name="wl-hover-text-color" id="wl-hover-text-color"
