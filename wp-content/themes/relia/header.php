                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 row">
                            ...
                            <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="col-md-6"><img src="<?php echo esc_url( get_theme_mod( 'relia_header_logo', get_template_directory_uri() . '/inc/images/relia-logo.png' ) ); ?>" alt="<?php bloginfo( 'name' ); ?>"
                            ...
                            <div class="col-md-6 search-and-cart fadeInRight <?php echo is_front_page() ? 'wow' : ''; ?>">
                                ...
                                <?php endif; ?>
                                <a class="search-and-cart" href="tel:+479081777"><i class="fa fa-phone"></i>(+33)4 79 08 17 77</a>
                            </div>
